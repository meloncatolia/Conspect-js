...
console.log(2 + 2 * 2 !== '6');
// "=" - присваивание
// "==" - не строгое стравнение (только по значению)
// "===" - строгое сравнивание (помимо значения должен совпадать тип данных)

// && - оператор "и" (работает только когда все выражения правдивы)
// || - оператор "или" (работает когда хотя бы одно выражение правдиво)
// ! - оператор отрицания
