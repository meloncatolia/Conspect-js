...
// console.log(answer + 5); // Выдаст "склееное" число - не нужный нам результат, т.к. нам нужна сумма введённого числа и 5. Если перед prompt поставить +, то выдаст нужное значение
...
document.write(answers); // Устаревшая команда, которая полностью замещает весь контент на сайте. На странице выведутся ответы на prompt, которые ввёл пользователь
